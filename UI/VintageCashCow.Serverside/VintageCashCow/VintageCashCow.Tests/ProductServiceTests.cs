...
namespace VintageCashCow.Tests
{
    ...
    public class ProductServiceTests
    {
        ...
        private void VerifyLoggerErrorCalledOnce()
        {
            ...
            Assert.That(count, Is.EqualTo(1), "Expected a single error-level Log invocation");
        }
        ...
        public async Task UpdateProductPriceAsync_SendsCorrectRequest()
        {
            ...
            var svc = CreateService((req, ct) =>
            {
                ...
                {
                    Content = new StringContent(JsonSerializer.Serialize(expected, JsonOptions), Encoding.UTF8, "application/json")
                });
            });
